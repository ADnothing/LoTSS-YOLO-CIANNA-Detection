...
content = os.listdir(LoTSS_path)
list_fits = [f for f in content if os.path.isfile(os.path.join(LoTSS_path,f))]
...
for fits_file in list_fits:
	...
	os.rename("./fwd_res/net0_0000.dat", "./fwd_res/net0_LoTSS_"+fits_file[:-5]+".dat")
